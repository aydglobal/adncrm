...
export function LegalFooter({ centered = false }: LegalFooterProps) {
  return (
    <footer
      className={`rounded-[1.4rem] border border-[var(--color-line)] bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.015))] px-4 py-4 text-sm text-[var(--color-muted)] ${
